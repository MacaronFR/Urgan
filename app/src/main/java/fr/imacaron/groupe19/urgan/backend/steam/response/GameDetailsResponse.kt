...
data class GameDetailsResponse(
    ...
    data class Data(
        ...
        @SerializedName("mac_requirements"        ) var macRequirements      : ArrayList<String>        = arrayListOf(),
        @SerializedName("linux_requirements"      ) var linuxRequirements    : ArrayList<String>        = arrayListOf(),
